...
export const CONFIG_INDICES = i18n.translate(
  ...
  {
    defaultMessage: 'Use indices from Security Solution advanced settings', // DERBY sanitized
  }
);
...
export const INDEX_HELPER_TEXT = i18n.translate(
  ...
  {
    defaultMessage:
      'Enter the pattern of indices where you would like this rule to run. By default, these will include index patterns defined in Security Solution advanced settings.', // DERBY sanitized
  }
);
