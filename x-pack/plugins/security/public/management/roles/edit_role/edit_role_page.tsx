...
export const EditRolePage: FunctionComponent<Props> = ({
  ...
  const description = spaces.enabled ? (
    <FormattedMessage
      ...
      defaultMessage="Set privileges on your data and control access to your PRISM spaces."
    />
  ) : (
    <FormattedMessage
      id="xpack.security.management.editRole.setPrivilegesToKibanaDescription"
      defaultMessage="Set privileges on your data and control access to PRISM."
    />
  );
