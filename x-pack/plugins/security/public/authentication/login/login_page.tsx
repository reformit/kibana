...
import { prismAnalyticsLogo, prismAppName } from '../../../../../derby/constants';
...
const infoMessageMap = new Map([
  ...
  [
    ...
    i18n.translate('xpack.security.login.loggedOutDescription', {
      defaultMessage: `You have logged out of ${prismAppName}.`, // DERBY Sanitized
    }),
  ],
]);
        ...
        <header className="loginWelcome__header">
          <div className={contentHeaderClasses}>
            ...
            <span className="loginWelcome__logo">
              <img src={prismAnalyticsLogo} alt={`${prismAppName} Logo`} />
            </span>
