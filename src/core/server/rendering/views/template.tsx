...
export const Template: FunctionComponent<Props> = ({
  ...
  const logo = (
    <img
      ...
      src={prismAnalyticsIcon}
      alt={`${prismAppName} Icon`}
    />
  );
  return (
    <html lang={locale}>
      <head>
        ...
        <title>{prismAppName}</title> {/* DERBY sanitized */}
          ...
          <div className="kbnLoaderWrap">
            ...
            <div
              ...
              data-error-message={i18n('core.ui.welcomeErrorMessage', {
                defaultMessage: `${prismAppName} did not load properly. Check the server output for more information.`,
              })}
            >
              {i18n('core.ui.welcomeMessage', { defaultMessage: `Loading ${prismAppName}` })}
            </div>
        ...
        <div className="kbnWelcomeView" id="kbn_legacy_browser_error" style={{ display: 'none' }}>
          ...
          <div className="kbnWelcomeText">
            {i18n('core.ui.legacyBrowserMessage', {
              defaultMessage: `This ${prismAppName} installation has strict security requirements enabled that your current browser does not meet.`,
            })}
          </div>
        </div>
