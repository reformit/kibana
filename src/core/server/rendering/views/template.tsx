...
export const Template: FunctionComponent<Props> = ({
  ...
  // DERBY Image
  const logo = (
    <img style={{ width: '50px', height: '50px' }} src={prismAnalyticsIcon} alt="PRISM Logo" />
  );
  return (
    <html lang={locale}>
      <head>
        ...
        <title>{defaultAppName}</title> {/* DERBY sanitized */}
          ...
          <div className="kbnLoaderWrap">
            ...
            <div
              ...
              data-error-message={i18n('core.ui.welcomeErrorMessage', {
                defaultMessage:
                  'PRISM did not load properly. Check the server output for more information.',
              })}
            >
        ...
        <div className="kbnWelcomeView" id="kbn_legacy_browser_error" style={{ display: 'none' }}>
          ...
          <div className="kbnWelcomeText">
            {i18n('core.ui.legacyBrowserMessage', {
              defaultMessage:
                'This PRISM installation has strict security requirements enabled that your current browser does not meet.',
            })}
          </div>
        </div>
